...
const DETAIL = {
  ...
  kpi: {
    title: 'Pipeline Performance Metrics', subtitle: '9 Years · 6 Key Indicators', sparkMeta: 'Refresh: Real-time · Source: delta_gold.kpi_metrics',
    html: `<div class="detail-block"><div class="kpi-grid"><div class="kpi-card"><span class="kpi-value">9+</span><span class="kpi-label">Years Exp</span></div><div class="kpi-card"><span class="kpi-value">180/day</span><span class="kpi-label">Auto Jobs</span></div><div class="kpi-card"><span class="kpi-value">100 GB</span><span class="kpi-label">Daily Data</span></div><div class="kpi-card"><span class="kpi-value">40%</span><span class="kpi-label">Query Gain</span></div><div class="kpi-card"><span class="kpi-value">15 hrs</span><span class="kpi-label">Saved/Week</span></div><div class="kpi-card"><span class="kpi-value">5,000</span><span class="kpi-label">Peak DAU</span></div></div></div>`
  }
};
...
class PipelineEngine {
  ...
  buildHTML() {
    ...
    const activities = [
      ...
      { id: 'kpi', zone: 'zone-gold-activities', icon: '📊', label: 'Performance KPIs', sub: '9 Years · 6 Metrics', layer: 'gold' },
    ];
